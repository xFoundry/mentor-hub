...
/**
 * Staff-only chat page for testing the AI orchestrator.
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-center">
        ...
        <p className="text-muted-foreground max-w-sm">
          You don&apos;t have permission to access the AI Chat page.
    ...
    <div className="flex flex-col min-h-0 h-full gap-4 overflow-hidden">
      ...
      <div className="shrink-0">
        ...
        <p className="text-muted-foreground">
          Test the AI orchestrator. Ask questions about mentorship data, feedback, sessions, and more.
        </p>
      </div>

      {/* Chat interface - takes remaining space */}
      <div className="flex-1 min-h-0">
        <ChatContainer userContext={chatUserContext} />
      </div>
    </div>
  );
}
