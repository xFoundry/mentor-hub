...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-muted text-muted-foreground inline-flex h-9 w-full max-w-full items-center rounded-lg p-[3px]",
        "overflow-x-auto scrollbar-none scroll-smooth snap-x snap-mandatory",
        "md:w-fit md:justify-center md:overflow-x-visible",
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "snap-start md:flex-1 md:snap-align-none",
        className
      )}
      {...props}
    />
